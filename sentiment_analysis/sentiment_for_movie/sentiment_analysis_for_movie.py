...
# area = ['娱乐杂谈','综艺','明星综合']
area = ['预告','短片','影视杂谈','影视剪辑']

title = 'sentiment_analysis_per_video_movie.csv'
...
for a in area:
    ...
    # print(type(df['bv_id'].unique()))
    # df = df_.drop(['title'],axis=1)
...
# writer.writerow(['area','bv_id','positive','negative','total_words','pos/neg','pos_rate','neg_rate'])
